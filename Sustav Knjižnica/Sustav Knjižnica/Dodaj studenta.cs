...
namespace Sustav_Knjižnica
{
    public partial class Dodaj_studenta : Form
    {
        ...
        {
            if (MessageBox.Show("Želite li zatvoriti prozor?", "Alert", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {
                this.Close();
            }
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Jedno ili više polja nije popunjeno.","Suggest",MessageBoxButtons.OK,MessageBoxIcon.Information);
            }
        }
    }
}
