...
{
    public partial class Vrati_knjigu : Form
    {
        public Vrati_knjigu()
        {
            InitializeComponent();
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Pogrešan matični broj ili nema izdanih knjiga.","Error",MessageBoxButtons.OK,MessageBoxIcon.Error);
            }
        }

        private void Vrati_knjigu_Load(object sender, EventArgs e)
        {
        ...
        private void btnReturn_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Knjiga uspješno vraćena.","Success",MessageBoxButtons.OK,MessageBoxIcon.Information);
            Vrati_knjigu_Load(this,null);
        }
